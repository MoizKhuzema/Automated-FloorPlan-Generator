...
def render(width, height, rects):
    ...
    # Plot rectangles
    for rect in rects:
        if rect['label'] == 'living room' or rect['label'] == 'dinner space':
    ...
    for rect in rects:
        if rect['label'] == 'living room' or rect['label'] == 'dinner space':
            ...
            if rect['label'] == 'master bedroom' or rect['label'] == 'kid bedroom' or rect['label'] == 'guest room':
                color = '#F5DEB3'
            elif rect['label'] == 'toilet A' or rect['label'] == 'toilet B':
                color = '#F0F8FF'
            elif rect['label'] == 'balcony A':
                color = '#DCDCDC'
            elif rect['label'] == 'kitchen' or rect['label'] == 'laundry':
                color = '#FDF5E6'
            else:
                color = '#FFA500'
